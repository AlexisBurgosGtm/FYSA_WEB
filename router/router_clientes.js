...
router.post("/buscar_cliente", async(req,res)=>{
    ...
    let qry = `
        SELECT CLIENTES.CODCLIENTE, CLIENTES.NIT, CLIENTES.NOMBRE, CLIENTES.DIRECCION, 
            CLIENTES.CODMUNICIPIO, MUNICIPIO.DESMUNICIPIO, CLIENTES.CODDEPARTAMENTO, DEPARTAMENTOS.DESDEPARTAMENTO, 
            CLIENTES.TELEFONO, CLIENTES.LATITUD, CLIENTES.LONGITUD, CLIENTES.SALDO, CLIENTES.HABILITADO, CLIENTES.LASTSALE, CLIENTES.DIASCREDITO, CLIENTES.REFERENCIA
        FROM CLIENTES LEFT OUTER JOIN
            DEPARTAMENTOS ON CLIENTES.CODDEPARTAMENTO = DEPARTAMENTOS.CODDEPARTAMENTO LEFT OUTER JOIN
            MUNICIPIO ON CLIENTES.CODMUNICIPIO = MUNICIPIO.CODMUNICIPIO
...
router.post("/insert_cliente", async(req,res)=>{
    ...
    let qry = `
        INSERT INTO CLIENTES(EMPNIT,DPI,NIT,
            NOMBRE,DIRECCION,CODMUNICIPIO,CODDEPARTAMENTO,
