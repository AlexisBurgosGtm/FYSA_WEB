            ...
            <div class="card card-rounded shadow border-naranja">
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-6">
                            <br>
                            <h5 class="negrita text-naranja">Clasificaciones Generales</h5>
                        </div>
                        <div class="col-6">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <label class="modal-title text-naranja h3 negrita" id="lbTitulo"></label>
                        </div>
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control negrita text-verde border-naranja" id="txtDescripcion">
                            </div>                      
...
function addListeners(){
    ...
    btnGuardar.addEventListener('click',()=>{
        ...
        if(descripcion=='SN'){funciones.AvisoError('Escriba una descripción de la clasificación a agregar');return;};

        funciones.Confirmacion('¿Está seguro que desea CREAR/EDITAR esta Clasificación?')
        .then((value)=>{
            if(value==true){
                ...
                if(document.getElementById('txtCodigo').value==''){
                    ...
                    .then(()=>{
                        ...
                        funciones.Aviso('Clasificación agregada exitosamente!!');
                    ...
                    .catch(()=>{
                        funciones.AvisoError('No se pudo crear la nueva clasificación');
                        btnGuardar.disabled = false;
                        btnGuardar.innerHTML = `<i class="fal fa-save"></i>`;
                    ...
                    .then(()=>{
                        ...
                        funciones.Aviso('Clasificación actualizada exitosamente!!');
                    ...
                    .catch(()=>{
                        funciones.AvisoError('No se pudo actualizar la clasificación');
                        btnGuardar.disabled = false;
                        btnGuardar.innerHTML = `<i class="fal fa-save"></i>`;
...
function eliminar_clasificacion(codigo,ibBtn){
    ...
    funciones.Confirmacion('¿Está seguro que desea ELIMINAR esta clasificación?')
    .then((value)=>{
        if(value==true){
            ...
            .then(()=>{
                funciones.Aviso('Clasificación eliminada exitosamente!!');
            ...
            .catch(()=>{
                funciones.AvisoError('No se pudo eliminar, verifique si no existen productos asociados a esta clasificación')
                btn.disabled = false;
                btn.innerHTML = `<i class="fal fa-trash"></i>`;
            })
