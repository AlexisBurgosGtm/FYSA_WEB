                            ...
                            <div class="card card-rounded">
                                <div class="card-body p-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control negrita text-naranja" id="txtMinimo">
                                    </div>


                                     <div class="form-group">
                                        <label class="negrita text-secondary">Máximo de Inventario</label>
                                        <input type="number" class="form-control negrita text-naranja" id="txtMaximo">
                                    </div>

                                    <div class="form-group">
                                        <label class="negrita text-secondary">Notas</label>
                                        <input type="text" class="form-control negrita text-naranja" id="txtNotas">
                                    </div>
...
function addListeners(){
    ...
    btnGuardarMinmax.addEventListener('click',()=>{
        ...
        let notas = funciones.limpiarTexto(document.getElementById('txtNotas').value || '');


        funciones.Confirmacion('¿Está seguro que desea Actualizar estos Mínimos y Máximos?')
        .then((value)=>{
            if(value==true){
                ...
                .then(()=>{
                    ...
                    funciones.Aviso('Datos actualizados exitosamente!!');
                ...
                .catch(()=>{
                    funciones.AvisoError('No se pudo actualizar los datos')
                })
